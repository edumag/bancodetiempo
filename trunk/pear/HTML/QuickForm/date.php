    ...
    */
    var $_locale = array(
        ...
        'ca'    => array (
            ...
            'weekdays_long' => array ('Diumenge', 'Dilluns', 'Dimarts', 'Dimecres', 'Dijous', 'Divedres', 'Dissabte'),
            'months_short'  => array ('Gen', 'Febr', 'Març', 'Abr', 'Maig', 'Juny', 'Jul', 'Ag', 'Sept', 'Oct', 'Nov', 'Des'),
            'months_long'   => array ('gener', 'febrer', 'mar&ccedil;', 'abril', 'maig', 'juny', 'juliol', 'agost', 'setembre', 'octubre', 'novembre', 'desembre')
        ),
        'hu'    => array (
