...
class cLogEntry {
	public $log_id;
	public $log_date;
	public $admin_id; // usually a member_id, but not always
	public $category; // See inc.global.php for constants used in this field
	public $action;	// See inc.global.php for constants used in this field
	public $ref_id; // usually refences a trade_id, feedback_id, or similar
	public $note;
...
class cSystemEvent {
	public $event_type; // See inc.global.php for constants used in this field
	public $event_interval; // See inc.config.php for interval settings
