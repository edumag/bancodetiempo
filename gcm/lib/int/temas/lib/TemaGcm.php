...
class TemaGcm {
   ...
   /** Listado de ficheros del tema [tipo][modulo/tipo/nombre] = url de archivo */
    ...
    public function incluir_javascript($ficheros=NULL,$librerias=NULL,$url_base) {
      ...
      // Hacemos que el javascript se unifique en un solo archivo
    ...
    *
    * El archivo temas/css/segun_navegador.css sera incluido al final, dandonos una
    * opción de añadir reglas diferentes para diferentes navegadores o dispositivos
    *
   ...
   function construir_css() {
      ...
      if ( isset($_GET['css']) && !empty ($_GET['css']) ) {
         ...
         foreach ( $this->ficheros['css'] as $llave => $fichero) {
            ...
            if ( $llave != 'temas/css/body.css'  && $llave != 'temas/css/segun_navegador.css' ) {
               echo "\n/* fichero:".$llave.": */\n";
               include($fichero);
               echo "\n/* acaba:".$llave.": */\n";
               }
         ...
         echo "\n/* fichero:temas/css/segun_navegador.css: */\n";
         include($this->ficheros['css']['temas/css/segun_navegador.css']);
         echo "\n/* acaba:temas/css/segun_navegador.css: */\n";
